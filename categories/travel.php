...
<body>
    <div class="container">
        <form method="post">
            ...
            <div class="question">
                ...
                <li>2. What's your preferred method for managing your finances while traveling (e.g., cash, credit
                    cards,
                ...
                <li>6. Are there any specific foods or local dishes you're eager to try? <br>
    ...
    $query = "insert into traveldata(name,age,school,eemail,phno,address,sp1,sp2,sp3,sp4,sp5,sp6,sp7,sp8,sp9,sp10) values('$p','$q','$r','$s','$t','$u','$f','$g','$h','$i','$j','$k','$l','$m','$n','$o')";
